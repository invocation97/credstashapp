...
export default function ToolbarPlugin() {
  ...
  useEffect(() => {
    return mergeRegister(
      ...
      editor.registerCommand(
        INSERT_UNORDERED_LIST_COMMAND,
        (_payload) => {
          console.log("Inserting unordered list", _payload);
  ...
  function toggleBlock(type: "h1" | "h2" | "h3" | "quote" | "ul" | "ol") {
    const selection = $getSelection();
    ...
    if (type === "ul") {
      return $setBlocksType(selection, () => $createListNode("bullet"));
    }
    if (type === "ol") {
      return $setBlocksType(selection, () => $createListNode("number"));
    }
  }
